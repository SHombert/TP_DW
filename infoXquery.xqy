        ...
        <act nom="{$act/an:etatCivil/an:ident/an:prenom} {$act/an:etatCivil/an:ident/an:nom}"> {
            ...
            return
                <sc nom="{$sc/an:titre}"
                    ...
                    mandat="{$act/an:mandats/an:mandat[an:uid eq $acteur/an:mandatRef]/an:infosQualite/an:libQualiteSex/text()} {$org[./an:uid eq $act/an:mandats/an:mandat[./an:uid eq $acteur/an:mandatRef]/an:organes/an:organeRef]/an:libelle}"
