...
public class InfoDom{
  ...
  public InfoDom (){
    ...
    public void traiter (){
          ...
          for(int j=0; j<params.getLength(); ++j){
            ...
            if(param.getTagName()== "mandats"){ // recuperation de tous les mandats de l'acteur
              ...
              for(int k=0; k<mandats.getLength();++k){
                ...
                newMandat.setLib(mand.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getLastChild().getTextContent());// libQualiteSex
                newMandat.setOrgRef(mand.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getFirstChild().getTextContent());
         ...
         *  Pour tous les scrutins, si bon libelle, ajouter le sc à chaque acteur ayant voté pour
         */ 
        ...
        for (int i=0;i<scrutins.getLength();++i){
          ...
          String titre = scrut.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getTextContent();

          if (titre.contains("l'information")){
            String date = scrut.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getTextContent();
            String sort = scrut.getFirstChild().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getNextSibling().getFirstChild().getTextContent();
            String grp = scrut.getLastChild().getPreviousSibling().getFirstChild().getFirstChild().getNextSibling().getFirstChild().getFirstChild().getTextContent();
            NodeList pours = scrut.getLastChild().getPreviousSibling().getFirstChild().getFirstChild().getNextSibling().getFirstChild().getLastChild().getLastChild().getFirstChild().getNextSibling().getChildNodes();
            ...
            for (int j=0; j<pours.getLength();++j){
              ...
              Mandat m =acteurs.get(votant.getFirstChild().getTextContent()).getMandat(votant.getFirstChild().getNextSibling().getTextContent());
